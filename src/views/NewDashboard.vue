  ...
  <section  v-if="services" class="mt-4 form--width mx-auto">
    ...
    <form>
      <div class="container border--magenta rounded form-group pb-4">
        <label>Title</label>
        <input type="text" class="form-control text-center" name="" placeholder="Titel" v-model="services[serviceID].dashboards[services[serviceID].dashboards.length -1].name">
        <br>
