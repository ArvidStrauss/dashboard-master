  ...
  <section  v-if="dashboards" class="mt-4 form--width mx-auto border--magenta px-2">
    ...
    <form>
      <div class="container form-group pb-4">
        <label>Title</label>
        <input type="text" class="form-control text-center" name="" placeholder="Titel" v-model="dashboards[dashboards.length -1].name">
        <br>
        <label>Description</label>
        <textarea rows="3" class="form-control text-center" placeholder="Beschreibung" v-model="dashboards[dashboards.length -1].description"></textarea>
        <br>
